...
qutm = ADDON.getLocalizedString(32022)
 

dialog = xbmcgui.Dialog()
#sel= dialog.select(adn, [sus, pof, rtl, rta, rtk, rls, lof, scr, stt, sti, flm ])
#sel= dialog.select(adn, [sus, pof, rbt, kil, rtk, rls, lof, scr, stt, sti, flm ])
sel = dialog.select(adn, [rtk, rbt, qut, pof, kil, scr, rls, sus, lof, flm, stt, sti ])
